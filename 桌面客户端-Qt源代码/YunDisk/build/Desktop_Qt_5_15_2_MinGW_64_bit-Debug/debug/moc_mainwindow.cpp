...
#include <memory>
#include "../../../../../../../../Desktop/YunDisk/mainwindow.h"
...
QT_MOC_LITERAL(3, 23, 7), // "setUser"
QT_MOC_LITERAL(4, 31, 4) // "user"

    },
    "MainWindow\0changeUser\0\0setUser\0user"
};
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWindow::setUser)) {
                *result = 1;
                return;
            }
        }
